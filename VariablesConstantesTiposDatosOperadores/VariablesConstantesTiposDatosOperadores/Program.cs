...
namespace VariablesConstantesTiposDatosOperadores
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            int num5 = 12 - 63;
            int num6 = 26 * 14;
            float num7 = 5f / 3;// o (float) 5 / 3;
            Console.Write("Suma:{0}, Resta:{1}, Multiplicación: {2}, Division: {3}", num4, num5, num6, num7);
            ...
            //Orden de evaluación de operadores númericos aritméticos
            int num8 = 4 * 3 / 2;
            int num9 = 4 * (3 / 2);
            int num10 = 4 + 6 * (2 - 1);
            //Operadores Lógicos
